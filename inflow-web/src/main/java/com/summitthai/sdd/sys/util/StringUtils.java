...
public class StringUtils {
    ...
    /**
     * ทำการ replace input โดยค้นหา คำที่เหมือนกับ target ใน input แล้วเปลี่ยน เป็น replace <BR>
     * Ex <BR>
     ...
     * Ex <BR>
     *  String s = "ERI00099: Archive Error [6 2017 Medium `P2-97-021B' is not local at: 192.100.5.125][OFFLINE]"; <BR>
    ...
    /**   Convert filed to Name of Columb 
     * Exam.   referenceValue1Text ==> REFERENCE_VALUE1_TEXT
     * **/
